...
<%@ taglib uri="http://www.rupeng.com/tag" prefix="rupeng" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="mainDiv" class="container" style="margin-top: 35px;">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-info" style="margin-top: 3px;">
                    <div class="panel-body">
                        <div><p>${question.errorInfo }</p></div>
                    </div>
                </div> 
                ...
                <!-- 如果问题已被解决，就不能再回答了 -->
                    ...
                    <form onsubmit="ajaxSubmitForm(this)" action="<%=ctxPath %>/question/answer" method="post">
                ...
                <div class="panel panel-success">
                    <div class="panel-body">
                        <!-- 答案列表 -->
                       	<rupeng:questionAnswers question="${question }" rootAnswerList="${rootAnswerList }"/>
                     </div>
                </div>
                <!-- 隐藏的编辑器，当补充回答时显示出来 -->
                    ...
                    <script type="text/javascript">
                        ...
                        $(function(){
                            ...
                            $("[adopt]").click(function(){
                                $.post("<%=ctxPath%>/question/adopt","questionAnswerId="+$(this).attr("adopt"),function(ajaxResult){
