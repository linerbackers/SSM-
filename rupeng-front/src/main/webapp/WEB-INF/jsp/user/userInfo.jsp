        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a class="list-group-item" href="<%=ctxPath%>/user/passwordUpdate.do?id=${user.id}"><span class="glyphicon glyphicon-lock">&nbsp;</span><span>修改密码</span></a>
                    <c:if test="${user.isTeacher==false }">
	                    <a class="list-group-item" href="<%=ctxPath%>/user/studentHome.do"><span class="glyphicon glyphicon-home">&nbsp;</span><span>学习中心 &gt;&gt;</span></a>
                    </c:if>
    				<c:if test="${user.isTeacher==true }">
	                    <a class="list-group-item" href="<%=ctxPath%>/user/teacherHome.do?id=${user.id}"><span class="glyphicon glyphicon-home">&nbsp;</span><span>教学中心 &gt;&gt;</span></a>
    				</c:if>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h4>
                            <img style="max-width: 50px;" src="http://static.rupeng.com/static/imgs/msg.gif">
                            请完善您的个人信息，我们将根据您的学校、年级、专业等向您推荐适合您的学习资料，当如鹏举办线下活动时也会通知相应城市的同学参加！如鹏不会向第三方透露您的个人信息，请放心填写！
                        </h4>
                        
                        <form onsubmit="ajaxSubmitForm(this)" class="form-horizontal" action="<%=ctxPath%>/user/userInfo.do">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <c:if test="${user.isMale==true }">
                                  		 checked="checked"
                                    </c:if>
                                     />男</label>
                                    <label class="radio-inline"><input type="radio" name="isMale" 
                                    <c:if test="${user.isMale==false }">
                                  		 checked="checked"
                                    </c:if> 
                                    />女</label>                                        
                                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h4><img style="max-width: 50px;" src="<%=ctxPath %>/images/msg.gif">   
                        ...
                        <form onsubmit="ajaxSubmitForm(this)" class="form-horizontal" action="<%=ctxPath%>/user/userPhone.do">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <input type="button" class="btn btn-default" value="获取短信验证码" onclick="sendSMSCode('<%=ctxPath %>/smsCode.do', $('#phone').val(), this)" />
                                    </div>
