...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath %>/page/card/add.do" method="post" class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <c:forEach items="${subjectList}" var="subject">
                    <input id="subject${subject.id }" type="checkbox" name="subjectIds" value="${subject.id }" /><label for="subject${subject.id }" style="margin-right: 10px;">${subject.name }</label>
            </c:forEach>
            </div>
            <div class="col-5"></div>
        </div>
