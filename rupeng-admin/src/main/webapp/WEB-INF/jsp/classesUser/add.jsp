...
<div class="pd-20">
    <div class="text-c">
        <form action="<%=ctxPath%>/page/classesUser/add.do" method="post">
            ...
            <tbody>
                <c:forEach items="${pageInfo.list }" var="user">
                    <tr>
                        ...
                        <td>${user.phone }</td>
                        <td>
                            <button class="btn size-MINI radius" onclick="ajaxSubmit('<%=ctxPath%>/page/classesUser/add','classesId=${classesId }&userId=${user.id }')">添加到班级</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
