...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=ctxPath %>/page/classes/update.do" method="post" class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="col-10">
                    ...
                    <input id="subject${subject.id }" type="radio" name="subjectId" value="${subject.id }"
                    	<c:if test="${subject.id==classes.subjectId }">checked="checked"</c:if>
